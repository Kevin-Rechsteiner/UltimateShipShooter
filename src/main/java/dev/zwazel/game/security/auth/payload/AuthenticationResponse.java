package dev.zwazel.game.security.auth.payload;

import com.fasterxml.jackson.annotation.JsonProperty;
import dev.zwazel.game.security.Role;
import dev.zwazel.game.security.auth.AuthenticationController;
 ...
 * @see dev.zwazel.game.security.jwt.JwtService - Generates JWT tokens
 */
@Data
@Builder
@NoArgsConstructor
...
public class AuthenticationResponse {
     ...
     *       with its associated {@link dev.zwazel.game.security.Privilege} set</li>
     *   <li>Examples:
     *       <ul>
     ...
     * </ul>
     *
     * @see dev.zwazel.game.security.Role - Enum mapping roles to privileges
     * @see dev.zwazel.game.security.Privilege - Fine-grained permission enumeration
     */
     ...
     * </ul>
     *
     * @see dev.zwazel.game.security.jwt.JwtService - Generates and validates tokens
     * @see dev.zwazel.game.security.config.JwtAuthenticationFilter - Extracts and validates token from request
     */
