...
import dev.zwazel.game.security.auth.AuthenticationService;
 ...
 *   <li>AuthenticationManager loads User from database (via {@link dev.zwazel.game.user.UserRepository})</li>
